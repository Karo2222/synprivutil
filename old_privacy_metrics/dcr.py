...
from SynPrivUtil_Framework.synprivutil.privacy_metrics import DCRCalculator
...
if __name__ == "__main__":
    ...
    dcr_calculator = DCRCalculator(original_data=original_df, synthetic_data=synthetic_df, distance_metric='euclidean')
