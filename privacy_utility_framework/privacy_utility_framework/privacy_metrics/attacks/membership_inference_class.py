...
from privacy_utility_framework.privacy_utility_framework.models.models import CTGANModel
...
class MembershipInferenceCalculator(PrivacyMetricCalculator):
    ...
    def evaluate(self):
        ...
        synthetic_data = pd.read_csv("/datasets/synthetic/insurance_datasets/random_sample.csv")
        ...
        sdg_knowledge = BlackBoxKnowledge(
            generator=CTGAN_TAPAS("/datasets/synthetic/diabetes_datasets/ctgan_model.pkl"),  # No generator is needed, as we already have synthetic data
